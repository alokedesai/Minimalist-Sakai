...
$('input[type="submit"]').addClass("btn btn-primary pull-right btn-lg");
$('input[type="submit"]').removeAttr("id")

//style the textinputs
...
// if (window.location.pathname = "/portal/login") {
	...
	// $select = $("<select class='form-control' name='realm'> </select>");
